...
/* 
    ...
    <a href="/about" className="text-sm  font-bold leading-6 text-red-600 hover:text-green-600 ">
              Read more <span aria-hidden="true">→</span>
                ...
                <p class="flex h-10 items-center justify-center lg:py-0 py-8 bg-red-600 px-4 text-xs  lg:text-base text-white px-6 lg:px-8 tracking-wide">Next Screening: <span class=' font-semibold ml-2 mr-2'>  Issaquah Film Festival, August 4/5</span></p>
